  ...
  return (
    <div>
        <label
            ...
            <svg
                class="absolute bg-white left-0 top-1/2 h-[2em] w-[2em] -translate-x-full -translate-y-1/2 duration-500 ease-out [stroke-dasharray:100] [stroke-dashoffset:100] peer-checked:[stroke-dashoffset:0]"
                viewBox="0 0 38 37"
                fill="none"
                height="37"
                width="38"
            ...
            <p class="text-[1em] font-semibold [user-select:none]">yes?</p>
        </label>
